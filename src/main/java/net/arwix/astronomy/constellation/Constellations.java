...
public class Constellations {
    ...
    private static final String[] cns_namemap = {"Андромеда (And: Andromeda)", "Насос (Ant: Antlia)",
            "Райская птица (Aps: Apus)", "Орел (Aql: Aquila)", "Водолей (Aqr: Aquarius)",
            "Жертвенник (Ara: Ara)", "Овен (Ari: Aries)", "Возничий (Aur: Auriga)",
            "Волопас (Boo: Bootes)", "Большой Пес (CMa: Canis Major)",
            "Малый Пес (CMi: Canis Minor)", "Гончие Псы (CVn: Canes Venatici)",
            "Резец (Cae: Caelum)", "Жираф (Cam: Camelopardalis)", "Козерог (Cap: Capricornus)",
            "Киль (Car: Carina)", "Кассиопея (Cas: Cassiopeia)", "Центавр (Cen: Centaurus)",
            "Цефей (Cep: Cepheus)", "Кит (Cet: Cetus)", "Хамелеон (Cha: Chamaeleon)",
            "Циркуль (Cir: Circinus)", "Рак (Cnc: Cancer)", "Голубь (Col: Columba)",
            "Волосы Вероники (Com: Coma Berenices)", "Южная Корона (CrA: Corona Australis)",
            "Северная Корона (CrB: Corona Borealis)", "Чаша (Crt: Crater)",
            "Южный Крест (Cru: Crux)", "Ворон (Crv: Corvus)", "Лебедь (Cyg: Cygnus)",
            "Дельфин (Del: Delphinus)", "Золотая Рыба (Dor: Dorado)", "Дракон (Dra: Draco)",
            "Малый Конь (Equ: Equuleus)", "Эридан (Eri: Eridanus)", "Печь (For: Fornax)",
            "Близнецы (Gem: Gemini)", "Журавль (Gru: Grus)", "Геркулес (Her: Hercules)",
            "Часы (Hor: Horologium)", "Гидра (Hya: Hydra)", "Южная Гидра (Hyi: Hydrus)",
            "Индеец (Ind: Indus)", "Малый Лев (LMi: Leo Minor)", "Ящерица (Lac: Lacerta)",
            "Лев (Leo: Leo)", "Заяц (Lep: Lepus)", "Весы (Lib: Libra)", "Волк (Lup: Lupus)",
            "Рысь (Lyn: Lynx)", "Лира (Lyr: Lyra)", "Столовая Гора (Men: Mensa)",
            "Микроскоп (Mic: Microscopium)", "Единорог (Mon: Monoceros)", "Муха (Mus: Musca)",
            "Наугольник (Nor: Norma)", "Октант (Oct: Octans)", "Змееносец (Oph: Ophiuchus)",
            "Орион (Ori: Orion)", "Павлин (Pav: Pavo)", "Пегас (Peg: Pegasus)",
            "Персей (Per: Perseus)", "Феникс (Phe: Phoenix)", "Живописец (Pic: Pictor)",
            "Южная Рыба (PsA: Piscis Austrinus)", "Рыбы (Psc: Pisces)", "Корма (Pup: Puppis)",
            "Компас (Pyx: Pyxis)", "Сетка (Ret: Reticulum)", "Скульптор (Scl: Sculptor)",
            "Скорпион (Sco: Scorpius)", "Щит (Sct: Scutum)", "Голова Змеи (Ser: Serpens Caput)",
            "Секстант (Sex: Sextans)", "Стрела (Sge: Sagitta)", "Стрелец (Sgr: Sagittarius)",
            "Телец (Tau: Taurus)", "Телескоп (Tel: Telescopium)",
            "Южный Треугольник (TrA: Triangulum Australe)", "Треугольник (Tri: Triangulum)",
            "Тукан (Tuc: Tucana)", "Большая Медведица (UMa: Ursa Major)",
            "Малая Медведица (UMi: Ursa Minor)", "Паруса (Vel: Vela)", "Дева (Vir: Virgo)",
            "Летучая Рыба (Vol: Volans)", "Лисичка (Vul: Vulpecula)",
            "Хвост Змеи (Ser: Serpens Cauda)"};
